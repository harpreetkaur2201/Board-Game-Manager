        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeReq = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameMasters", x => x.GMID);
                    table.ForeignKey(
                        name: "FK_GameMasters_Players_PlayerID",
                        column: x => x.PlayerID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameSessions_GameMasters_GMID",
                        column: x => x.GMID,
                        principalTable: "GameMasters",
                        principalColumn: "GMID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GameSessions_Tournaments_TournamentID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionParticipants", x => new { x.SessionID, x.PlayerID });
                    table.ForeignKey(
                        name: "FK_SessionParticipants_GameSessions_SessionID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameSessions_GMID",
                table: "GameSessions",
                column: "GMID");

            migrationBuilder.CreateIndex(
                name: "IX_GameSessions_TournamentID",
                table: "GameSessions",
                column: "TournamentID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionParticipants_SessionID_Rank",
                table: "SessionParticipants",
